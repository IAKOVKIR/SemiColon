...
class FriendFragmentViewModelFactory(private val myID: Int, private val userID: Int, private val userDataSource: UserDao,
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(FriendFragmentViewModel::class.java)) {
            return FriendFragmentViewModel(myID, userID, userDataSource, followerDataSource, application) as T
        }
