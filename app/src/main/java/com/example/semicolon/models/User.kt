 ...
 */
data class User(val userId: Int, val username: String, val firstName: String, val lastName: String, val phone : String, val password : String, val rating : Float, val email: String) {
