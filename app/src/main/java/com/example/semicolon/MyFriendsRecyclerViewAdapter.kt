...
/**
 * [RecyclerView.Adapter] that can display a [FriendItem] and makes a call to the
 * specified [OnListFragmentInteractionListener].
 */
class MyFriendsRecyclerViewAdapter(
    private val mValues: List<FriendItem>,
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.mContentView.text = item.secondName
