            ...
            0 -> {
                ...
                if (list is RecyclerView)
                    with(list) {
                        ...
                        adapter = MyFriendsRecyclerViewAdapter(data.readAllFollowers(param1[0]), context,
                            listener as TabLayout.OnListFragmentInteractionListener, param1[0], false)
                    }
                ...
                if (list is RecyclerView)
                    with(list) {
                        ...
                        adapter = MyFriendsRecyclerViewAdapter(listOf(), context,
                            listener as TabLayout.OnListFragmentInteractionListener, param1[0], false)
                    }
